...
public class WorldPlayerBoundary : MonoBehaviour
{
    [Header("Настройки телепортации")]
    // Координаты, которые вы указали
    private Vector3 targetPosition = new Vector3(4.28999996f, 2.24300003f, -13.0699997f);
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.GetComponent<FP_Controller>() != null)
        {
