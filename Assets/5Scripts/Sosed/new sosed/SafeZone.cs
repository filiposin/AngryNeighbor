...
public class SafeZone : MonoBehaviour
{
    ...
    [SerializeField] private node_AIMovement enemyMovement;
    ...
    private void Awake()
    {
        ...
        if (enemyMovement == null && findEnemyIfMissing)
            enemyMovement = FindObjectOfType<node_AIMovement>();
    ...
    private void HandlePlayerEntered(FP_Controller player)
    {
        ...
        if (enemyMovement != null && enemyMovement.IsChasingPlayer())
            enemyMovement.LosePlayerToSafeZone();
    }
